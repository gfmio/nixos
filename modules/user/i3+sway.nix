{ lib, pkgs, i3 ? false, terminal ? "kitty", menu ? "${pkgs.dmenu}/bin/dmenu_run", lockCommand }:
...
let
  ...
  i3nag = ''exec "i3-nagbar -t warning -m 'You pressed the exit shortcut. Do you really want to exit i3? This will end your X session.' -B 'Yes, exit i3' 'i3-msg exit'"'';
  swaynag = ''exec "swaynag -t warning -m 'You pressed the exit shortcut. Do you really want to exit sway? This will end your Wayland session.' -B 'Yes, exit sway' 'swaymsg exit'"'';
