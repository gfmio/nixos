...
in
{
    ...
    modules = {
      hardware = {
        nvidia = {
          ...
          setKernelParams = mkOption { type = types.bool; default = true; };
          blacklistNouveau = mkOption { type = types.bool; default = true; };
          setAvailableKernelModules = mkOption { type = types.bool; default = true; };
          enablePrime = mkOption { type = types.bool; default = false; };
  ...
  config = mkIf cfg.enable {
    ...
    boot.initrd.availableKernelModules = mkIf cfg.setAvailableKernelModules [ "nvidia" "nvidia_modeset" "nvidia_uvm" "nvidia_drm" ];
